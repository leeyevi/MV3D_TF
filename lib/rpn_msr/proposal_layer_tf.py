...
from utils.transform import bv_anchor_to_lidar, lidar_to_bv, lidar_to_image, lidar_to_bv_4
import pdb
...
# 1. rois: lidar_bv 
# 4. rois_3d
def proposal_layer_3d(rpn_cls_prob_reshape,rpn_bbox_pred,im_info,cfg_key,_feat_stride = [16,]):
    # Algorithm:
    #
    # for each (H, W) location i
    #   generate A anchor boxes centered on cell i
    ...
    # return lidar_bv_proposals, blob
    # return lidar_bv_proposals, image_proposals, blob
    #top[0].reshape(*(blob.shape))
    #top[0].data[...] = blob
